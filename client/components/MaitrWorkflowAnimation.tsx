...
export default function MaitrWorkflowAnimation() {
  ...
  return (
    <div className="relative w-full">
      ...
      {/*
        Der frühere CompactStatsSection steht jetzt als
        client/components/sections/WorkflowStatsSection.tsx direkt in
        client/pages/Index.tsx. Grund: Er ist statisches Markup ohne
        framer-motion, hing hier aber am lazy()-Chunk dieser Komponente und
        fehlte deshalb im vorgerenderten HTML.
      */}
    </div>
  );
}
