        ...
        <div className="relative w-full">
            ...
            <div className="relative w-full h-[700px] flex items-center justify-center overflow-hidden mb-12">
                <AnimatePresence mode="wait">
                    ...
                    {workflowState === 'data-import' && <DataImportStage key="data-import" />}
        ...
        >
            ...
            >
                <div className="text-center">
                    ...
                    <div className="text-xs text-gray-600 font-medium">Analysieren läuft...</div>
                </div>
            </motion.div>
                        ...
                        <div className="h-full overflow-y-auto">
                                ...
                                >
                                    <div className="w-9 h-9 bg-purple-600 rounded-lg flex items-center justify-center shadow-md">
                                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            {/* Fork */}
                                            <path d="M7 2V12M7 12V22M7 12H9M9 2V12M9 12V22M11 2V8" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                                            {/* Knife */}
                                            <path d="M17 2V12L15 22M17 2L15 12L17 22" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                    <span className="font-black text-xl text-purple-600">Bella</span>
                                </motion.div>
                            ...
                            <div className="px-6 pb-5">
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <span className="text-[10px] text-purple-600 font-medium">Alle →</span>
                                </div>
                                ...
                                <div className="space-y-2.5">
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-1">
                                            <h4 className="font-bold text-gray-900 text-xs">Wiener Schnitzel</h4>
                                            <span className="text-orange-500 font-black text-xs">18.90€</span>
                                        </div>
                                        <p className="text-[10px] text-gray-400">Mit Pommes & Salat</p>
                                    </motion.div>
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-1">
                                            <h4 className="font-bold text-gray-900 text-xs">Spaghetti Carbonara</h4>
                                            <span className="text-orange-500 font-black text-xs">14.50€</span>
                                        </div>
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-1">
                                            <h4 className="font-bold text-gray-900 text-xs">Caesar Salad</h4>
                                            <span className="text-orange-500 font-black text-xs">12.90€</span>
                                        </div>
                                        <p className="text-[10px] text-gray-400">Frisch & knackig</p>
                                    </motion.div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 text-xs">
                                    ...
                                    <span className="text-gray-600 font-medium">Heute: 09:00 – 17:00</span>
                                    <span className="bg-red-100 text-red-600 px-2 py-0.5 rounded-full text-[10px] font-bold">Geschlossen</span>
                                </div>
            ...
            >
                <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
                    ...
                    <svg className="w-24 h-24" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <rect x="8" y="8" width="28" height="28" fill="none" stroke="#000000" strokeWidth="4" rx="3" />
                        <rect x="16" y="16" width="12" height="12" fill="#000000" rx="2" />

                        {/* TOP RIGHT Corner Pattern */}
                        <rect x="64" y="8" width="28" height="28" fill="none" stroke="#000000" strokeWidth="4" rx="3" />
                        <rect x="72" y="16" width="12" height="12" fill="#000000" rx="2" />

                        {/* BOTTOM LEFT Corner Pattern */}
                        <rect x="8" y="64" width="28" height="28" fill="none" stroke="#000000" strokeWidth="4" rx="3" />
                ...
                <div className="text-center">
                    <p className="text-lg font-black bg-gradient-to-r from-teal-600 to-purple-600 bg-clip-text text-transparent mb-1">Deine App ist live!</p>
...
// Compact Stats Section Below Animation
function CompactStatsSection() {
    return (
        <div className="max-w-5xl mx-auto">
            {/* Stats Grid - MORE COLORFUL */}
            <div className="grid grid-cols-3 gap-8 mb-12">
                <div className="bg-gradient-to-br from-teal-50 to-white backdrop-blur rounded-2xl p-6 shadow-xl border border-teal-200/60 text-center">
                    <div className="text-5xl font-black bg-gradient-to-r from-teal-500 via-teal-600 to-cyan-600 bg-clip-text text-transparent mb-3">
                        +50%
                    </div>
                    <div className="text-base font-bold text-gray-800">Mehr Sichtbarkeit</div>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-white backdrop-blur rounded-2xl p-6 shadow-xl border border-purple-200/60 text-center">
                    <div className="text-5xl font-black bg-gradient-to-r from-purple-500 via-fuchsia-500 to-pink-500 bg-clip-text text-transparent mb-3">
                        5x
                    </div>
                    <div className="text-base font-bold text-gray-800">Traffic</div>
                </div>
                <div className="bg-gradient-to-br from-orange-50 to-white backdrop-blur rounded-2xl p-6 shadow-xl border border-orange-200/60 text-center">
                    <div className="text-5xl font-black bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 bg-clip-text text-transparent">
                        Mehr Kunden
                    </div>
                </div>
            </div>

            {/* Problem Statement - Maitr Style, Larger, NO BUTTON */}
            <div className="bg-gradient-to-br from-white/95 via-teal-50/60 to-purple-50/40 backdrop-blur-xl rounded-3xl p-10 shadow-2xl border border-white/60">
                <p className="text-3xl font-black bg-gradient-to-r from-gray-900 via-teal-800 to-purple-800 bg-clip-text text-transparent mb-4 text-center leading-tight">
                    Viele Restaurants sind online unsichtbar
                </p>
                <p className="text-xl text-gray-700 text-center font-medium">
                    Maitr ändert das. Für dich.
                </p>
            </div>
        </div>
    );
