          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Intelligente Personalplanung mit Echtzeit-Optimierung
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
        {[
          ...
          },
          {
            ...
            value:
              Math.round(
                demoStaff.reduce((a, s) => a + s.performance, 0) /
                  demoStaff.length,
              ) + "%",
            total: null,
          ...
          },
          {
            ...
            change:
              conflicts.length === 0 ? "Alle gelöst!" : "KI-Lösungen bereit",
            icon: AlertTriangle,
            color:
              conflicts.length > 0
          ...
          <div className="card-elevated bg-white rounded-2xl p-6">
            ...
            <div className="space-y-4">
              {demoStaff.map((member) => (
                <div
                  key={member.id}
                  className="p-4 rounded-xl border border-gray-100 hover:border-blue-200 hover:shadow-sm transition-all cursor-pointer group"
                >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    KW 5, 2026 • Optimiert für 94% Effizienz
                  </p>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  {demoStaff.map((member) => (
                    ...
                    >
                      ...
                      {Array.from({ length: 7 }).map((_, dayIndex) => {
                        const dayShifts = demoShifts.filter(
                          (shift) =>
                        ...
                        return (
                          <td
                            key={dayIndex}
                            className="px-2 py-4 border-l border-gray-200"
                          >
                              ...
                              {dayShifts.length > 0 ? (
                                dayShifts.map((shift) => (
                                  ...
                                  >
                                    ...
                                    {shift.notes && (
                                      <p
                                        className="text-gray-700 mt-1 text-xs truncate"
                                        title={shift.notes}
                                      >
                                        {shift.notes}
                                      </p>
      ...
      <div className="card-elevated bg-white rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Intelligente Teamanalyse und Optimierungsvorschläge
            </p>
          </div>
