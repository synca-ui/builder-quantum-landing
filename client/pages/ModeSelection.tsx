...
export default function ModeSelection() {
  ...
  const { maitrScore: hookScore, scoreStatus } = useMaitrScore(
    decodedUrl,
    webhookConfirmed,
  );
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-teal-50/40 to-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-5 pt-10 pb-16">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-1 text-xs text-gray-400">
                  Logos & Farben können nach dem Start des automatischen Modus
                  angepasst werden.
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
                  Schritt-für-Schritt-Einrichtung, bei der du alles selbst
                  bestimmst.
                </p>
              </div>
            </div>
          ...
          {/* Automatisch */}
          <div
            className={`relative rounded-2xl shadow-sm p-6 flex flex-col border transition-shadow duration-300 hover:shadow-md ${highScore ? "border-purple-300 bg-gradient-to-b from-purple-50 to-white" : "border-purple-200 bg-white"}`}
          >
            ...
            <div className="flex items-start gap-3 mb-4 mt-1">
              ...
              <div>
                <h3 className="font-bold text-gray-900 text-base">
                  Automatisch (Zero-Input)
                </h3>
                <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
                  Wir extrahieren Name, Adresse, Öffnungszeiten, Fotos und mehr
                  — und erstellen eine veröffentlichungsfertige App.
                </p>
              </div>
            </div>
            <ul className="text-xs text-gray-500 space-y-1.5 mb-6 ml-0.5">
        ...
        <p className="mt-8 text-center text-xs text-gray-400">
          Brauchen Sie Hilfe? Unser Concierge kann die Einrichtung für Sie
          abschließen.
        </p>
      </div>
    </div>
