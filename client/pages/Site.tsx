        ...
        <div className={`min-h-screen relative ${fontClass}`} style={{ background: styles.userBackground, color: styles.userFontColor }}>
            ...
            {menuOpen && (
                <div className="fixed inset-0 z-20">
                    <div className="fixed inset-0 bg-black/30" style={{ top: 'calc(max(env(safe-area-inset-top, 50px), 50px) + 56px)' }} onClick={() => setMenuOpen(false)} />
                    <div className="fixed left-0 right-0 bg-white border-b border-black/10 shadow-lg" style={{ top: 'calc(max(env(safe-area-inset-top, 50px), 50px) + 56px)' }}>
            ...
            {productOpen && (
                <div className="absolute inset-0 z-30 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white text-gray-900 rounded-2xl w-full max-w-sm p-5 shadow-2xl">
                        ...
                        <img src={normalizeUrl(productOpen.image)} alt={productOpen.name} className="w-full h-40 object-cover rounded-lg mb-4" />
