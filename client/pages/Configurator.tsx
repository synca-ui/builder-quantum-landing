        ...
        <div className="space-y-4">
              ...
              {businessTypes.map((type) => (
                ...
                >
                  <CardContent className="p-3 text-center">
                    <div className={`w-8 h-8 mx-auto mb-2 rounded-lg bg-gradient-to-r ${type.gradient} flex items-center justify-center text-white`}>
                      {type.icon}
                    </div>
          ...
          {showOptionalFields && (
            <div className="space-y-4 pt-2 border-t border-gray-100">
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-2">What makes you special?</label>
                <Textarea
