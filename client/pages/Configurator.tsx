...
export default function Configurator() {
  ...
  // Use separate selectors to avoid object reference changes on every render
  ...
  // ===== STABLE STEPS REFERENCE =====
  // Use the externally-defined constant to prevent recreation on every render
  // This ensures stable references for all useMemo/useCallback dependencies
