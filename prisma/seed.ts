...
const templates = [
  {
    id: 'minimalist',
    name: 'Minimalist',
    description: 'A clean, modern design with minimal visual elements. Perfect for upscale dining experiences.',
    ...
    preview: {
      ...
      features: ['Clean typography', 'Minimal colors', 'Elegant spacing', 'Professional layout']
    }
  },
  {
    id: 'modern',
    name: 'Modern',
    description: 'A contemporary design with bold typography and dynamic layouts. Great for trending restaurants.',
    category: ['GASTRONOMY'],
    layout: {
      intent: 'COMMERCIAL',
    ...
    preview: {
      ...
      features: ['Bold colors', 'Dynamic layouts', 'Modern fonts', 'Interactive elements']
    }
  },
  {
    id: 'stylish',
    name: 'Stylish',
    description: 'An artistic and creative design with visual storytelling. Ideal for trendy and creative restaurants.',
    ...
    preview: {
      ...
      features: ['Artistic design', 'Visual storytelling', 'Premium aesthetics', 'Creative layouts']
    }
  },
  {
    id: 'cozy',
    name: 'Cozy',
    description: 'A warm and inviting design with earthy tones. Perfect for casual and neighborhood restaurants.',
    category: ['GASTRONOMY'],
    layout: {
      intent: 'NARRATIVE',
      navigation: 'top-horizontal',
    ...
    preview: {
      ...
      features: ['Warm colors', 'Friendly atmosphere', 'Comfortable layouts', 'Inviting typography']
    }
  }
];
